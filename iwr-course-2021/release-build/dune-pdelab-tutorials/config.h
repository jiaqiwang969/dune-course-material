...
/* Define to 1 if you have module dune-pdelab-tutorials available */
#define HAVE_DUNE_PDELAB_TUTORIALS 1
...
/* Define to 1 if you have module consistent-edge-orientation available */
#define HAVE_CONSISTENT_EDGE_ORIENTATION 0


/* Define to 1 if you have module dune-opcounter available */
#define HAVE_DUNE_OPCOUNTER 0


/* Define to 1 if you have module dune-codegen available */
#define HAVE_DUNE_CODEGEN 1
...
#define DUNE_CODEGEN_VERSION "0.0"

/* Define to the major version of dune-codegen */
#define DUNE_CODEGEN_VERSION_MAJOR 0

/* Define to the minor version of dune-codegen */
#define DUNE_CODEGEN_VERSION_MINOR 0

/* Define to the revision of dune-codegen */
#define DUNE_CODEGEN_VERSION_REVISION 0



/* begin dune-pdelab-tutorials
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-pdelab-tutorials"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "peter.bastian@iwr.uni-heidelberg.de"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-pdelab-tutorials"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-pdelab-tutorials 0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-pdelab-tutorials"
...
/* Define to the version of dune-pdelab-tutorials */
#define Udune_pdelab_tutorials_VERSION ""

/* Define to the major version of dune-pdelab-tutorials */
#define Udune_pdelab_tutorials_VERSION_MAJOR 

/* Define to the minor version of dune-pdelab-tutorials */
#define Udune_pdelab_tutorials_VERSION_MINOR 

/* Define to the revision of dune-pdelab-tutorials */
#define Udune_pdelab_tutorials_VERSION_REVISION 

/* end dune-pdelab-tutorials

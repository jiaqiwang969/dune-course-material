...
#include "blockstructured_preconditioner_poisson_unstructured_rOperator_file.hh"
#include "blockstructured_preconditioner_poisson_unstructured_rCoarseOperator_file.hh"
#include "blockstructured_preconditioner_poisson_unstructured_rPointDiagonal_file.hh"
#include "blockstructured_preconditioner_poisson_unstructured_interpolation_operator_file.hh"
#include "blockstructured_preconditioner_poisson_unstructured_restriction_operator_file.hh"
...
int main(int argc, char** argv){
  ...
  // Set up constraints container...
  using C_CC = GFS::ConstraintsContainer<RangeType>::Type;
  C_CC c_cc;
  c_cc.clear();
